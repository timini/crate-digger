...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::map::map_get,
            commands::map::map_edges,
            commands::map::map_neighbours,
            commands::map::map_unplaced,
            commands::map::map_rebuild,
            commands::map::map_cancel,
            commands::playlists::playlist_workspace,
            commands::playlists::playlist_ready_counts,
            commands::playlists::playlist_brief_set,
            commands::playlists::playlist_seeds_save,
            commands::playlists::playlist_discovery_set,
            commands::playlists::playlist_discover_now,
            commands::playlists::playlist_queue,
            commands::playlists::playlist_feedback,
            commands::playlists::playlist_feedback_undo,
            ...
            commands::review::review_wrong_version,
            commands::review::evaluation_report,
            commands::review::evaluation_save,
